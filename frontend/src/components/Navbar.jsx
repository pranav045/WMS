  ...
  return (
    <>
      <style>{`
        ...
        /* PERFECT SPACING — only 20px extra from logo */
        .nav-links {
          list-style: none;
          display: flex;
          gap: 32px;
          margin: 0;
          padding: 0;
          margin-left: 20px;   /* ← This is the sweet spot */
        }
        ...
        .nav-links li a:hover { color: #2E8B57; background: rgba(46,139,87,0.06); }
        .nav-links li a.active { color: #2E8B57; font-weight: 600; }
